...
export const TRADUCTIONS = {
  fr: {
    ...
    corpus: {
      ...
      supprimer: "Supprimer ce corpus",
      confirmerSuppressionTitre: "Supprimer définitivement ce corpus ?",
      confirmerSuppressionTexte: "Cette action est irréversible. Les entretiens qui y sont rattachés ne seront pas supprimés — ils redeviennent des entretiens personnels, mais quitteront ce corpus partagé.",
    ...
    etudeQuant: {
      ...
      lancerAnalyse: "Lancer l'analyse",
      optionsAnalyseTitre: "Quelles analyses veux-tu inclure ?",
      optionsAnalyseAide: "Les statistiques descriptives, la fiabilité et les corrélations sont toujours calculées. Le reste est optionnel — décoche ce dont tu n'as pas besoin.",
      optionAfe: "Analyse factorielle exploratoire (AFE)",
      optionAfc: "Analyse factorielle confirmatoire (AFC)",
      optionRegression: "Régressions multiples",
      optionMediation: "Tests de médiation",
      optionPasserelle: "Passerelle qualitative-quantitative",
      optionSynthese: "Synthèse interprétative par IA",
      ...
      passerelleEnCours: "Identification des thèmes dans les réponses libres…",
      passerelleTitre: "Passerelle qualitative-quantitative",
      passerelleAucunLien: "Aucun lien statistiquement significatif détecté avec les variables du modèle.",
  ...
  en: {
    ...
    corpus: {
      ...
      supprimer: "Delete this corpus",
      confirmerSuppressionTitre: "Permanently delete this corpus?",
      confirmerSuppressionTexte: "This action is irreversible. Interviews attached to it will not be deleted — they become personal interviews again, but will leave this shared corpus.",
    ...
    etudeQuant: {
      ...
      lancerAnalyse: "Run the analysis",
      optionsAnalyseTitre: "Which analyses do you want to include?",
      optionsAnalyseAide: "Descriptive statistics, reliability and correlations are always computed. The rest is optional — uncheck what you don't need.",
      optionAfe: "Exploratory factor analysis (EFA)",
      optionAfc: "Confirmatory factor analysis (CFA)",
      optionRegression: "Multiple regressions",
      optionMediation: "Mediation tests",
      optionPasserelle: "Qualitative-quantitative bridge",
      optionSynthese: "AI interpretive synthesis",
      ...
      passerelleEnCours: "Identifying themes in open-ended responses…",
      passerelleTitre: "Qualitative-quantitative bridge",
      passerelleAucunLien: "No statistically significant link detected with the model's variables.",
