...
COUT_CREDIT_TRANSCRIPTION = float(os.getenv("COUT_CREDIT_TRANSCRIPTION", "2"))
COUT_CREDIT_ANALYSE = float(os.getenv("COUT_CREDIT_ANALYSE", "3"))
COUT_CREDIT_GUIDE = float(os.getenv("COUT_CREDIT_GUIDE", "2"))
COUT_CREDIT_ETUDE_QUANT = float(os.getenv("COUT_CREDIT_ETUDE_QUANT", "7"))
COUT_CREDIT_ANALYSE_QUANT = float(os.getenv("COUT_CREDIT_ANALYSE_QUANT", "5"))

# Recharge de crédits à la carte (paiement réel par les utilisateurs)
PRIX_CREDIT_FCFA = int(os.getenv("PRIX_CREDIT_FCFA", "200"))
